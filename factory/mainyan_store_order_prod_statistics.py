...
REPORT_ALLOWED_STORES = {"焙满香滨江店", "焙满香广钢店", "焙满香南州路店"}
...
# ─── 格式化模板配置 ──────────────────────────────────────────────────────────
ROW_CATEGORY_MAP = {
    2: ["冷冻面团", "面团现烤类", "面团包装类", "面团丹麦类", "面团吐司类", "面团定制款类"],
    3: ["成品面包类", "饼干类", "蛋糕类"],
    4: ["热销类", "慕斯类/外", "冷冻肉类", "冷冻馅料类", "冷藏馅料类", "油脂类", "粉类", "糖类", "常温馅料类", "干果类",
        "饼干类/外", "饮品类/外", "其他/外", "专版包材类", "公版包材类", "工衣工帽围裙", "模具", "保洁用品"],
    5: ["配送费"],
}
...
EXPORT_CATEGORY_MAP = {
    ...
    "成品面包饼干": ["成品面包类", "饼干类"],
    "蛋糕": ["蛋糕类"],
    "物料包材": ["热销类", "慕斯类/外", "冷冻肉类", "冷冻馅料类", "冷藏馅料类", "油脂类", "粉类", "糖类", "常温馅料类",
